...
- **D-11:** Verify auth header format (`Token <key>` vs `Bearer <key>`) during Phase 1 implementation — use whichever the k6 Cloud API requires; research flagged ambiguity
...
- **D-15:** Go version: 1.22 (matches Argo Rollouts v1.9.x toolchain)
