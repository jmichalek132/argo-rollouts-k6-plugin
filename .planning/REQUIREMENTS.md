...
- [x] **DIST-02**: goreleaser configuration produces multi-arch binaries (linux/amd64, linux/arm64, darwin/amd64, darwin/arm64) with SHA256 checksums
- [x] **DIST-03**: GitHub Actions CI: lint (`golangci-lint`), test (`go test -race`), build on PR and push; release on tag
